...
PLATFORM_API_VERSION = "platform.demoteam.dev/v1alpha1"
APPLICATION_RELEASE_PROMISE = "application-release"
        ...
        for entity in yaml.safe_load_all(value):
            ...
            apis.append(
                CatalogAPI(
                    ...
                    base_url=annotations.get("platform.demoteam.dev/base-url"),
                )
            )
    return apis
...
def cilium_namespace_lockdown_request(
    ...
    return {
        ...
        "metadata": {
            ...
            "namespace": namespace,
            "labels": {
                "kratix.io/component-of-promise-name": APPLICATION_RELEASE_PROMISE,

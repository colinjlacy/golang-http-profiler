...
LEGACY_PREFIX="${LEGACY_PREFIX:-ghcr.io/${GHCR_OWNER}/}golang-http-profiler"

REDIS_PIPELINE_IMAGE="${REDIS_PIPELINE_IMAGE:-${LEGACY_PREFIX}-redis-pipeline:${IMAGE_TAG}}"
CILIUM_API_ACCESS_PIPELINE_IMAGE="${CILIUM_API_ACCESS_PIPELINE_IMAGE:-${LEGACY_PREFIX}-cilium-api-access-pipeline:${IMAGE_TAG}}"
CILIUM_NAMESPACE_LOCKDOWN_PIPELINE_IMAGE="${CILIUM_NAMESPACE_LOCKDOWN_PIPELINE_IMAGE:-${LEGACY_PREFIX}-cilium-namespace-lockdown-pipeline:${IMAGE_TAG}}"
S3_BUCKET_PIPELINE_IMAGE="${S3_BUCKET_PIPELINE_IMAGE:-${LEGACY_PREFIX}-s3-bucket-pipeline:${IMAGE_TAG}}"
...
TODOS_API_IMAGE="${TODOS_API_IMAGE:-${LEGACY_PREFIX}-todos-api:${IMAGE_TAG}}"
REQUEST_LOGGER_IMAGE="${REQUEST_LOGGER_IMAGE:-${LEGACY_PREFIX}-request-logger:${IMAGE_TAG}}"
